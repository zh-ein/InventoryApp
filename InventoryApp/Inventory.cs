...

{
    public partial class frmAddProduct : Form
    {
        ...
        public string Product_Name(string name)
        {
            ...
            {
                throw new StringFormatException("Product name must be letters and spaces.");
            }
            return name;
        ...
        public int Quantity(string qty)
        {
            ...
            {
                throw new NumberFormatException("Quantity must be a numbers only.");
            }
        ...
        public double SellingPrice(string price)
        {
            ...
            {
                throw new CurrencyFormatException("Price must be numbers in decimals.");
            }
